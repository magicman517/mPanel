        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DequeueAfter = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_JobRecords", x => x.TrackingID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllowAccountSelfDeletion = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobRecords_QueuePolling",
                table: "JobRecords",
                columns: new[] { "QueueID", "ExecuteAfter", "ExpireOn", "DequeueAfter" },
                filter: "\"IsComplete\" = FALSE AND \"IsCancelled\" = FALSE");
        }
